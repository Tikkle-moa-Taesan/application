...
public class AccountController {
	...
	@ApiResponse(responseCode = "200", description = "요청 성공")
	@ApiResponse(responseCode = "400", description = "요청 실패")
	public ResponseEntity<SavingsAccountResponse> getSavingAccountDetail(@PathVariable Long accountId) {
		System.out.println("적금 계좌 단일 조회");
		SavingsAccountResponse response = accountService.getSavingAccountDetail(accountId);	
		return ResponseEntity.ok(response);
	}
}
